...
function Cv() {
	return (
		<section className='cv'>
			...
			<section className='cv_rightSide'>
				...
				<section className='cv_education'>
					...
					<div className='cv_education_training'>
						...
						<p className='cv_education_training-text'>
							-{'>'} Intensive training for 6 months{' '}
							<strong>(798 hours)</strong> to become a FullStack JS Developer.
						</p>
						<p className='cv_education_training-text'>
				...
				<section className='cv_graduation'>
					...
					<div className='cv_graduation_grad'>
						...
						<h4 className='cv_graduation_grad-subtitle'>
							RNCP Level 5 (Bac+2)
						</h4>
						<p className='cv_graduation_grad-text'>
							Obtained on August 17, 2022
						</p>
					</div>
				</section>
			</section>
