...
function AddProject({
	...
	setToken,
	getAllProject,
}: InferProps<typeof AddProject.propTypes>) {
		...
		<>
			{errorToggle ? (
				<section className='addProject_unauthorized'>
					...
					<button
						className='addProject_unauthorized_btn'
				...
				<section className='addProject'>
					<img
						className='addProject-closeModal'
						src={iconCloseModal}
						alt='icon Close modal'
						onClick={onClickCloseAddProject}></img>
					<h1 className='addProject-title'>Add Project:</h1>
					<form
