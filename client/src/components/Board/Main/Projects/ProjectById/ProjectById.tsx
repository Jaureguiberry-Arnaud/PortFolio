  ...
  <>
    {errorToggle
      ? <section className="projectById_unauthorized">
            <img className="projectById_unauthorized-warning" src={iconWarning} alt="warning icon"  />
            <div className="projectById_unauthorized-div">
              <h2 className="projectById_unauthorized_title">StatusCode:</h2>
              <p className="projectById_unauthorized_content">{errorToggle.status}</p>
            </div>
            <div className="projectById_unauthorized-div">
              <h2 className="projectById_unauthorized_title">StatusPost:</h2>
              <p className="projectById_unauthorized_content">{errorToggle.statusText}</p>
            </div>
            <div className="projectById_unauthorized-div">
              <h2 className="projectById_unauthorized_title">Request:</h2>
              <p className="projectById_unauthorized_content">Failed</p>
            </div>
            <button className="projectById_unauthorized_btn" onClick={onClickCloseWarning}>Close</button>
          </section>

      : <section className="projectById" >
          {status && (
            <section className="projectById_deleteSuccess">
              <h1 className="projectById_deleteSuccess-title">{status}</h1>
              {!toggleUpdate 
                ?<button className="projectById_deleteSuccess-btn" onClick={onClickCloseModalSuccess}>Close</button>
                :<button className="projectById_deleteSuccess-btn" onClick={onClickCloseModalProjectById}>Close</button>}
              
            </section>)}

          {toggleUpdate
            ? <Suspense fallback={null}>
              <form className="projectById_form" onSubmit={handleSubmitUpdate}>
                <img className="projectById-closeModal" src={iconCloseModal} alt="icon Close modal" onClick={onClickCloseUpdate} ></img>
                
                <h1 className="projectById_form-title">Update Project</h1>

                <label className="projectById_form-label" htmlFor="name">Project Name:</label>
                <input type="text"
                ...
                <label className="projectById_form-label" htmlFor="git_url">Git Url:</label>
                <input type="url"
                pattern="https://.*"
                name="git_url"
                className="projectById_form-input"
                ...
                <label className="projectById_form-label" htmlFor="web_url">Web Url:</label>
                <input type="url"
                pattern="https://.*"
                name="web_url"
                className="projectById_form-input"
                ...
                <label className="projectById_form-label" htmlFor="description">Description:</label>
            ...
            : <>
                <img className="projectById-closeModal" src={iconCloseModal} alt="icon Close modal" onClick={onClickCloseModalProjectById} ></img>
                <img className="projectById-delete" src={iconDelete} alt="icon Delete" onClick={onClickDeleteById}></img>
                <img className="projectById-update" src={iconUpdate} alt="icon Update" onClick={onClickUpdateById}></img>
